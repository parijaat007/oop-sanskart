    ...
    class ProductDetail extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                tvQty.setText("1");
                Picasso.get().load(getResources().getString(R.string.img_base_url) + "product_images/" + json_data.getString("image")).placeholder(R.drawable.cart_icon).into(ivProductImage);
